  ...
  return (
    <>
      <nav
        ...
        } z-0 items-center justify-self-end bg-light/5 font-sans text-sm  transition-all before:absolute  before:top-1/2 before:-left-full before:h-px before:w-full before:translate-x-8 before:-translate-y-1/2 sm:px-10  md:visible md:relative md:flex md:w-max md:translate-x-0 md:px-12 md:opacity-100 md:transition-none lg:pl-32 lg:pr-40  xl:before:bg-light/50`}
      >
